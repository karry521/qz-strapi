...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    userType: Attribute.Enumeration<['business', 'individuals']> &
      Attribute.Required &
      Attribute.DefaultTo<'individuals'>;
    last_login_ip: Attribute.String;
    orders: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::order.order'
    >;
    last_login_time: Attribute.DateTime;
...
export interface ApiAppVersionAppVersion extends Schema.CollectionType {
  ...
  attributes: {
    info: Attribute.JSON & Attribute.Required;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    merchant_no: Attribute.String;
    trade_no: Attribute.String;
    email: Attribute.String;
    payment_method: Attribute.String;
    payment_status: Attribute.String;
    expire_time: Attribute.DateTime;
    payment_channel_info: Attribute.JSON;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    valid_days: Attribute.Integer;
    use_num: Attribute.Integer;
    type: Attribute.Enumeration<['business', 'individuals']> &
      Attribute.Required &
      Attribute.DefaultTo<'individuals'>;
    json: Attribute.JSON & Attribute.Required;
    renew: Attribute.Enumeration<['Y', 'N']> &
      Attribute.Required &
      Attribute.DefaultTo<'N'>;
    advanced: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    device_num: Attribute.Integer & Attribute.Required;
...
export interface ApiSendTemplateSendTemplate extends Schema.CollectionType {
  collectionName: 'send_templates';
  info: {
    singularName: 'send-template';
    pluralName: 'send-templates';
...
export interface ApiUserActionTempUserActionTemp extends Schema.CollectionType {
  ...
  info: {
    singularName: 'user-action-temp';
    pluralName: 'user-action-temps';
    displayName: 'user-action-temp';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::user-action-temp.user-action-temp',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
